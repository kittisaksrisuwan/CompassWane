...
#[derive(Debug)]
pub struct CompassWaneProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CompassWaneProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CompassWane processing");
    
    let mut processor = CompassWaneProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CompassWaneProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CompassWaneProcessor::new(false);
